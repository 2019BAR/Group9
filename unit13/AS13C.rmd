...
plot(cutoff, result, type='l', col='cyan', lwd=2, main=sprintf(
  "Optimal Expected Result: $%d @ %.2f",result[i],cutoff[i]))
...
#Ans. 對某一些人做是比較好的，不做跟都做的期望報酬都不好。
&emsp; 【E】 在所有的商務情境都是這種狀況嗎？<br><br>
#Ans. 大部分情況下都會選擇對一些人做，只有少部份情況下才會選擇都做或都不做。
藉由調整報酬矩陣：<br>
&emsp; 【F】 模擬出「全不做」比「全做」還要好的狀況<br>
#Ans.在TN=0, FN=0, FP=-100, TP=0的情況下，可以模擬出來。
&emsp; 【G】 並舉出一個會發生這種狀況的商務情境<br><br>
#Ans. 評估是否針對年輕人進行達文西微創手術
